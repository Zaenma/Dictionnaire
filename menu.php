    ...
    <nav class="nav">
        <div>
            ...
            <ul class="nav__list">
                ...
                <a href="./dictionnaire.php" class="nav__link">
                    <i class='bx bx-user nav__icon'></i>
                    <span class="nav__text">Dictionnaire</span>
                </a>
                <a href="./expression.php" class="nav__link">
                    <i class='bx bx-bell nav__icon'></i>
                    <span class="nav__text">Exressions</span>
                </a>
